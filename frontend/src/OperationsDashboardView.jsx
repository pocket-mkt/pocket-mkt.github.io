...
const STATUS = { NOT_STARTED: ["시작 전", "muted"], IN_PROGRESS: ["진행중", "active"], DELAYED: ["지연", "delayed"], DONE: ["완료", "done"], ON_HOLD: ["보류", "hold"], BLOCKED: ["보류", "hold"] };
...
export function WorkspaceDailyMeetingsView({ dashboard, canWrite, onSave, onLoadWeek, onSearchMeetings }) {
