...
export function OperationsDashboardView({ dashboard, canWrite, actorName, onIssueCreate, onIssueUpdate, onIssueArchive, onOpenProject, onLoadWeek }) {
